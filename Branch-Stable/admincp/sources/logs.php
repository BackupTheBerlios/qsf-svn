...
class logs extends admin
{
	function execute()
	{
		...
		$pages = $this->htmlwidgets->get_pages( 'SELECT l.*, u.user_name FROM %plogs l, %pusers u WHERE u.user_id=l.log_user ORDER BY l.log_time DESC', 'a=logs', $this->get['min'], $this->get['num'] );
