...
class rssreader extends modlet
{
	...
	{
		if (isset($this->qsf->temp['MODLET_RSSREADER_TITLE']) && isset($this->qsf->temp['MODLET_RSSREADER_ITEM']) && isset($this->qsf->temp['MODLET_RSSREADER_MAIN'])) {
		...
		} else if (isset($this->qsf->temp['MAIN_RSSREADER_TITLE']) && isset($this->qsf->temp['MAIN_RSSREADER_ITEM']) && isset($this->qsf->temp['MAIN_RSSREADER_MAIN'])) {
		...
		} else if (isset($this->qsf->temp['ADMIN_RSSREADER_TITLE']) && isset($this->qsf->temp['ADMIN_RSSREADER_ITEM']) && isset($this->qsf->temp['ADMIN_RSSREADER_MAIN'])) {
