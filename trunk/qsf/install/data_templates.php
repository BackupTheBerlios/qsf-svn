...
{\$qsf->table}
  <tr>
    ...
    <td class=\'nav\' style=\'cursor:pointer; width:20%; text-align:center\' onclick=\"window.open(\'{\$qsf->self}?a=pm\',\'_self\');return false;\" onmouseover=\"this.className=\'navover\';\" onmouseout=\"this.className=\'nav\';\"><a href=\'{\$qsf->self}?a=pm\' class=\'{\$messageclass}\'>{\$qsf->lang->main_messenger}{\$MessageLink}</a></td>
  </tr>
{\$qsf->etable}
