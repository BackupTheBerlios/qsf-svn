    ...
    <form action='<?php echo $this->self; ?>' method='get'>
    ...
    <tr>
        <td><input type='radio' name='from' value='22' id='upgrade22' checked='checked' /></td>
        <td><label for='upgrade22'>Quicksilver Forums v1.3.0</label></td>
    </tr>
    <tr>
        <td><input type='radio' name='from' value='21' id='upgrade21' /></td>
    ...
    <tr>
        <td><input type='radio' name='from' value='19' id='upgrade19' /></td>
    ...
    <tr>
        ...
        <td><label for='upgrade16'>Quicksilver Forums v1.1.6</label></td>
    </tr>
    <tr>
        <td><input type='radio' name='from' value='15' id='upgrade15' /></td>
