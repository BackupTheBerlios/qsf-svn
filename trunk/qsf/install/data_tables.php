...
$queries[] = "INSERT INTO {$pre}timezones VALUES (2, 'Asia/Dubai', 'GST', 14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (3, 'Asia/Kabul', 'AFT', 16200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (4, 'America/Antigua', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (5, 'America/Anguilla', 'AST', -14400, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (8, 'America/Curacao', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (9, 'Africa/Luanda', 'WAT', 3600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (12, 'Antarctica/Rothera', 'ROTT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (13, 'Antarctica/Palmer', 'CLST', -10800, 1142132400)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (14, 'Antarctica/Mawson', 'MAWT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (15, 'Antarctica/Davis', 'DAVT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (16, 'Antarctica/Casey', 'WST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (17, 'Antarctica/Vostok', 'VOST', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (18, 'Antarctica/DumontDUrville', 'DDUT', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (19, 'Antarctica/Syowa', 'SYOT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (20, 'America/Argentina/Buenos_Aires', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (21, 'America/Argentina/Cordoba', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (22, 'America/Argentina/Jujuy', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (23, 'America/Argentina/Tucuman', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (24, 'America/Argentina/Catamarca', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (25, 'America/Argentina/La_Rioja', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (26, 'America/Argentina/San_Juan', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (27, 'America/Argentina/Mendoza', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (28, 'America/Argentina/Rio_Gallegos', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (29, 'America/Argentina/Ushuaia', 'ART', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (30, 'Pacific/Pago_Pago', 'SST', -39600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (38, 'Australia/Brisbane', 'EST', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (39, 'Australia/Lindeman', 'EST', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (40, 'Australia/Adelaide', 'CST', 37800, 1143909000)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (41, 'Australia/Darwin', 'CST', 34200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (42, 'Australia/Perth', 'WST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (43, 'America/Aruba', 'AST', -14400, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (47, 'America/Barbados', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (48, 'Asia/Dhaka', 'BDT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (49, 'Europe/Brussels', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (50, 'Africa/Ouagadougou', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (51, 'Europe/Sofia', 'EET', 7200, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (52, 'Asia/Bahrain', 'AST', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (53, 'Africa/Bujumbura', 'CAT', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (54, 'Africa/Porto-Novo', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (55, 'Atlantic/Bermuda', 'AST', -14400, 1143957600)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (56, 'Asia/Brunei', 'BNT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (57, 'America/La_Paz', 'BOT', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (58, 'America/Noronha', 'FNT', -7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (59, 'America/Belem', 'BRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (60, 'America/Fortaleza', 'BRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (61, 'America/Recife', 'BRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (62, 'America/Araguaina', 'BRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (63, 'America/Maceio', 'BRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (64, 'America/Bahia', 'BRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (65, 'America/Sao_Paulo', 'BRT', -10800, 1160881200)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (66, 'America/Campo_Grande', 'AMT', -14400, 1160884800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (67, 'America/Cuiaba', 'AMT', -14400, 1160884800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (68, 'America/Porto_Velho', 'AMT', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (69, 'America/Boa_Vista', 'AMT', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (70, 'America/Manaus', 'AMT', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (71, 'America/Eirunepe', 'ACT', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (72, 'America/Rio_Branco', 'ACT', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (73, 'America/Nassau', 'EST', -18000, 1143961200)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (74, 'Asia/Thimphu', 'BTT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (75, 'Africa/Gaborone', 'CAT', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (76, 'Europe/Minsk', 'EET', 7200, 1143331200)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (77, 'America/Belize', 'CST', -21600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (88, 'America/Coral_Harbour', 'EST', -18000, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (93, 'America/Regina', 'CST', -21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (94, 'America/Swift_Current', 'CST', -21600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (98, 'America/Dawson_Creek', 'MST', -25200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (102, 'Indian/Cocos', 'CCT', 23400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (103, 'Africa/Kinshasa', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (104, 'Africa/Lubumbashi', 'CAT', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (105, 'Africa/Bangui', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (106, 'Africa/Brazzaville', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (107, 'Europe/Zurich', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (108, 'Africa/Abidjan', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (109, 'Pacific/Rarotonga', 'CKT', -36000, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (112, 'Africa/Douala', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (113, 'Asia/Shanghai', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (114, 'Asia/Harbin', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (115, 'Asia/Chongqing', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (116, 'Asia/Urumqi', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (117, 'Asia/Kashgar', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (118, 'America/Bogota', 'COT', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (119, 'America/Costa_Rica', 'CST', -21600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (122, 'Atlantic/Cape_Verde', 'CVT', -3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (123, 'Indian/Christmas', 'CXT', 25200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (127, 'Africa/Djibouti', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (128, 'Europe/Copenhagen', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (129, 'America/Dominica', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (130, 'America/Santo_Domingo', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (131, 'Africa/Algiers', 'CET', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (132, 'America/Guayaquil', 'ECT', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (133, 'Pacific/Galapagos', 'GALT', -21600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (136, 'Africa/El_Aaiun', 'WET', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (137, 'Africa/Asmera', 'EAT', 10800, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (141, 'Africa/Addis_Ababa', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (142, 'Europe/Helsinki', 'EET', 7200, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (143, 'Pacific/Fiji', 'FJT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (144, 'Atlantic/Stanley', 'FKST', -10800, 1145163600)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (145, 'Pacific/Truk', 'TRUT', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (146, 'Pacific/Ponape', 'PONT', 39600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (147, 'Pacific/Kosrae', 'KOST', 39600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (150, 'Africa/Libreville', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (151, 'Europe/London', 'GMT', 0, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (152, 'America/Grenada', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (153, 'Asia/Tbilisi', 'GET', 10800, 1143327600)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (154, 'America/Cayenne', 'GFT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (155, 'Africa/Accra', 'GMT', 0, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (158, 'America/Danmarkshavn', 'GMT', 0, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (161, 'Africa/Banjul', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (162, 'Africa/Conakry', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (163, 'America/Guadeloupe', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (164, 'Africa/Malabo', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (165, 'Europe/Athens', 'EET', 7200, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (166, 'Atlantic/South_Georgia', 'GST', -7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (167, 'America/Guatemala', 'CST', -21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (168, 'Pacific/Guam', 'ChST', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (169, 'Africa/Bissau', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (170, 'America/Guyana', 'GYT', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (171, 'Asia/Hong_Kong', 'HKT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (172, 'America/Tegucigalpa', 'CST', -21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (173, 'Europe/Zagreb', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (174, 'America/Port-au-Prince', 'EST', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (175, 'Europe/Budapest', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (176, 'Asia/Jakarta', 'WIT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (177, 'Asia/Pontianak', 'WIT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (178, 'Asia/Makassar', 'CIT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (179, 'Asia/Jayapura', 'EIT', 32400, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (182, 'Asia/Calcutta', 'IST', 19800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (183, 'Indian/Chagos', 'IOT', 21600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (186, 'Atlantic/Reykjavik', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (187, 'Europe/Rome', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (188, 'America/Jamaica', 'EST', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (189, 'Asia/Amman', 'EET', 7200, 1143669600)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (190, 'Asia/Tokyo', 'JST', 32400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (191, 'Africa/Nairobi', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (192, 'Asia/Bishkek', 'KGT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (193, 'Asia/Phnom_Penh', 'ICT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (194, 'Pacific/Tarawa', 'GILT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (195, 'Pacific/Enderbury', 'PHOT', 46800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (196, 'Pacific/Kiritimati', 'LINT', 50400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (197, 'Indian/Comoro', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (198, 'America/St_Kitts', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (199, 'Asia/Pyongyang', 'KST', 32400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (200, 'Asia/Seoul', 'KST', 32400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (201, 'Asia/Kuwait', 'AST', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (202, 'America/Cayman', 'EST', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (203, 'Asia/Almaty', 'ALMT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (204, 'Asia/Qyzylorda', 'QYZT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (205, 'Asia/Aqtobe', 'AQTT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (206, 'Asia/Aqtau', 'AQTT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (207, 'Asia/Oral', 'ORAT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (208, 'Asia/Vientiane', 'ICT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (209, 'Asia/Beirut', 'EET', 7200, 1143324000)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (210, 'America/St_Lucia', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (211, 'Europe/Vaduz', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (212, 'Asia/Colombo', 'LKT', 21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (213, 'Africa/Monrovia', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (214, 'Africa/Maseru', 'SAST', 7200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (218, 'Africa/Tripoli', 'EET', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (219, 'Africa/Casablanca', 'WET', 0, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (222, 'Indian/Antananarivo', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (223, 'Pacific/Majuro', 'MHT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (224, 'Pacific/Kwajalein', 'MHT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (225, 'Europe/Skopje', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (226, 'Africa/Bamako', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (227, 'Asia/Rangoon', 'MMT', 23400, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (231, 'Asia/Macau', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (232, 'Pacific/Saipan', 'ChST', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (233, 'America/Martinique', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (234, 'Africa/Nouakchott', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (235, 'America/Montserrat', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (236, 'Europe/Malta', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (237, 'Indian/Mauritius', 'MUT', 14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (238, 'Indian/Maldives', 'MVT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (239, 'Africa/Blantyre', 'CAT', 7200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (246, 'America/Hermosillo', 'MST', -25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (247, 'America/Tijuana', 'PST', -28800, 1143972000)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (248, 'Asia/Kuala_Lumpur', 'MYT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (249, 'Asia/Kuching', 'MYT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (250, 'Africa/Maputo', 'CAT', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (251, 'Africa/Windhoek', 'WAST', 7200, 1143936000)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (252, 'Pacific/Noumea', 'NCT', 39600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (253, 'Africa/Niamey', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (254, 'Pacific/Norfolk', 'NFT', 41400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (255, 'Africa/Lagos', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (256, 'America/Managua', 'CST', -21600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (259, 'Asia/Katmandu', 'NPT', 20700, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (260, 'Pacific/Nauru', 'NRT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (261, 'Pacific/Niue', 'NUT', -39600, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (264, 'Asia/Muscat', 'GST', 14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (265, 'America/Panama', 'EST', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (266, 'America/Lima', 'PET', -18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (267, 'Pacific/Tahiti', 'TAHT', -36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (268, 'Pacific/Marquesas', 'MART', -34200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (269, 'Pacific/Gambier', 'GAMT', -32400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (270, 'Pacific/Port_Moresby', 'PGT', 36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (271, 'Asia/Manila', 'PHT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (272, 'Asia/Karachi', 'PKT', 18000, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (275, 'Pacific/Pitcairn', 'PST', -28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (276, 'America/Puerto_Rico', 'AST', -14400, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (281, 'Pacific/Palau', 'PWT', 32400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (282, 'America/Asuncion', 'PYST', -10800, 1142132400)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (283, 'Asia/Qatar', 'AST', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (284, 'Indian/Reunion', 'RET', 14400, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (300, 'Africa/Kigali', 'CAT', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (301, 'Asia/Riyadh', 'AST', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (302, 'Pacific/Guadalcanal', 'SBT', 39600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (303, 'Indian/Mahe', 'SCT', 14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (304, 'Africa/Khartoum', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (305, 'Europe/Stockholm', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (306, 'Asia/Singapore', 'SGT', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (307, 'Atlantic/St_Helena', 'GMT', 0, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (312, 'Africa/Freetown', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (313, 'Europe/San_Marino', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (314, 'Africa/Dakar', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (315, 'Africa/Mogadishu', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (316, 'America/Paramaribo', 'SRT', -10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (317, 'Africa/Sao_Tome', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (318, 'America/El_Salvador', 'CST', -21600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (319, 'Asia/Damascus', 'EET', 7200, 1143842400)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (320, 'Africa/Mbabane', 'SAST', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (321, 'America/Grand_Turk', 'EST', -18000, 1143954000)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (322, 'Africa/Ndjamena', 'WAT', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (323, 'Indian/Kerguelen', 'TFT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (324, 'Africa/Lome', 'GMT', 0, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (325, 'Asia/Bangkok', 'ICT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (326, 'Asia/Dushanbe', 'TJT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (327, 'Pacific/Fakaofo', 'TKT', -36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (328, 'Asia/Dili', 'TLT', 32400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (329, 'Asia/Ashgabat', 'TMT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (330, 'Africa/Tunis', 'CET', 3600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (331, 'Pacific/Tongatapu', 'TOT', 46800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (332, 'Europe/Istanbul', 'EET', 7200, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (333, 'America/Port_of_Spain', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (334, 'Pacific/Funafuti', 'TVT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (335, 'Asia/Taipei', 'CST', 28800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (336, 'Africa/Dar_es_Salaam', 'EAT', 10800, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (341, 'Africa/Kampala', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (342, 'Pacific/Johnston', 'HST', -36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (343, 'Pacific/Midway', 'SST', -39600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (344, 'Pacific/Wake', 'WAKT', 43200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (359, 'America/Phoenix', 'MST', -25200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}timezones VALUES (366, 'Pacific/Honolulu', 'HST', -36000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (367, 'America/Montevideo', 'UYST', -7200, 1142136000)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (368, 'Asia/Samarkand', 'UZT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (369, 'Asia/Tashkent', 'UZT', 18000, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (370, 'Europe/Vatican', 'CET', 3600, 1143334800)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (371, 'America/St_Vincent', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (372, 'America/Caracas', 'VET', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (373, 'America/Tortola', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (374, 'America/St_Thomas', 'AST', -14400, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (375, 'Asia/Saigon', 'ICT', 25200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (376, 'Pacific/Efate', 'VUT', 39600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (377, 'Pacific/Wallis', 'WFT', 43200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (378, 'Pacific/Apia', 'WST', -39600, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (379, 'Asia/Aden', 'AST', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (380, 'Indian/Mayotte', 'EAT', 10800, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (381, 'Africa/Johannesburg', 'SAST', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (382, 'Africa/Lusaka', 'CAT', 7200, 1144190569)";
$queries[] = "INSERT INTO {$pre}timezones VALUES (383, 'Africa/Harare', 'CAT', 7200, 1144190569)";
...
$queries[] = "INSERT INTO {$pre}skins (skin_name, skin_dir) VALUES ('QSF Comet', 'default')";
