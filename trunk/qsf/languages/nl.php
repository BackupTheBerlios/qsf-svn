...
class nl
{
	...
	function mbcode()
	{
		...
		$this->mbcode_deepink = 'Roze';
		$this->mbcode_detail = 'Geef een beschrijving';
		$this->mbcode_email = 'E-mail';
		$this->mbcode_firered = 'Baksteen Rood';
		$this->mbcode_font = 'Lettertype';
		$this->mbcode_green = 'Groen';
		$this->mbcode_huge = 'Heel groot';
		...
		$this->mbcode_royalblue = 'Royal Blauw';
		$this->mbcode_sandybrown = 'Zand Bruin';
		$this->mbcode_seagreen = 'Zee Groen';
		$this->mbcode_sienna = 'Bruin';
		$this->mbcode_silver = 'Zilver';
		$this->mbcode_size = 'Grootte';
		$this->mbcode_skyblue = 'Lucht Blauw';
