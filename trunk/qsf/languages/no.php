...
class no
{
	...
	function board()
	{
		...
		$this->board_noview = 'Du har ikke tilatelse til � lese forumet.';
		$this->board_regfirst = 'Du har ikke tilatelse til � lese forumet. Hvis du registrerer deg, s� kan du.';
	...
	function cp()
	{
		...
		$this->cp_avatar_current = 'Din n�v�rende avatara';
		$this->cp_avatar_error = 'Avatara feil';
		$this->cp_avatar_must_select = 'Du m� velge en avatara.';
		$this->cp_avatar_none = 'Ikke bruk noen avatara';
		$this->cp_avatar_pixels = 'punkter';
		$this->cp_avatar_select = 'Velg en avatara';
		$this->cp_avatar_size_height = 'Din avataras h�yde m� v�re mellom 1 og';
		$this->cp_avatar_size_width = 'Din avataras bredde m� v�re mellom 1 och';
		...
		$this->cp_avatar_upload_not_image = 'Du kan bare laste opp bilder for � benytte som avatara.';
		$this->cp_avatar_upload_too_large = 'Avataraen du valgte � laste opp er for stor. Maks st�rrelse er %d kilobyte.';
		...
		$this->cp_current_avatar = 'N�v�rende Avatara';
		...
		$this->cp_less_charac = 'Ditt navn m� v�re kortere enn 32 bokstaver.';
		...
		$this->cp_size_max = 'Avataraen er for stor. Maks st�rrelse er %s x %s punkter.';
		$this->cp_skin = 'Skin';
	...
	function email()
	{
		...
		$this->email_no_fields = 'G� tilbake og kontroller at alle feltene er utfyllt.';
		$this->email_no_member = 'Det finnes ikke noe medlem med det navnet.';
		$this->email_no_perm = 'Du har ikke tilgang til � sende e-post via forumet..';
	...
	function forum()
	{
		...
		$this->forum_cant_topics = 'Du kan ikke se p� emner i dette forumet.';
		...
		$this->forum_not = 'Ikke';
		$this->forum_noview = 'Du har ikke tiletelse � se p� forum.';
		$this->forum_pages = 'Sider';
		$this->forum_pinned = 'Merket';
		$this->forum_pinned_topic = 'Merket emne';
		$this->forum_poll = 'Avstemmning';
		$this->forum_regfirst = 'Du har ikkee tilgang til � se p� forum uten f�rst � registrere deg.';
		...
		$this->forum_subscribe = 'Motta e-post n�r det kommer nye innlegg i dette forum.';
	...
	function login()
	{
		$this->login_cant_logged = 'Du klarte ikke � logge inn. Forsikre deg om at ditt brukernavn og passord er rett.<br /><br />Pass p� store og sm� bokstaver, s� \'UsErNaMe\' er ikke det samme som \'Username\'. Cookies m� ogs� v�re aktivert.';
		$this->login_cookies = 'Cookies m� v�re aktivert for � kunne logge inn.';
		$this->login_forgot_pass = 'Forgot your password?'; //Translate
		$this->login_header = 'Logger inn';
		$this->login_logged = 'Du er n� p�logget.';
	...
	function main()
	{
		...
		$this->main_activate_resend = 'Send aktiverings e-post p� nytt';
		$this->main_admincp = 'admin kontrollpanel';
		$this->main_banned = 'Du har blitt utel�st fra dette forum.';
		$this->main_code = 'Kode';
		...
		$this->main_max_load = 'Beklageligvis s� er %s utilgjengelig pga for mange samtidige brukere.';
	...
	function members()
	{
		...
		$this->members_vist_www = 'Bes�k denna brukerens hjemmeside';
	...
	function mod()
	{
		...
		$this->mod_no_action = 'Du m� gj�re et valg.';
		...
		$this->mod_perm_topic_delete = 'Du har ikke tillatelse til � slette dette emne.';
		$this->mod_perm_topic_edit = 'Du har ikke tillatelse til � redigere dette emne.';
		$this->mod_perm_topic_lock = 'Du har ikke tillatelse til � lese dette emne.';
		$this->mod_perm_topic_move = 'Du har ikke tillatelse til � flytte dette emne';
		$this->mod_perm_topic_pin = 'Du har ikke tillatelse til � markere dette emne.';
		$this->mod_perm_topic_split = 'You do not have permission to split this topic.'; //Translate
		$this->mod_perm_topic_unlock = 'Du har ikke tillatelse til � l�se opp dette emne.';
		$this->mod_perm_topic_unpin = 'Du har ikke tillatelse til � fjerne markeringen p� dette emne.';
	...
	function pm()
	{
		...
		$this->pm_no_folder = 'Du m� velge en katalog.';
		...
		$this->pm_sendon = 'Sending p�';
		$this->pm_success = 'Meldingen er sendt.';
		$this->pm_sure_del = 'Er du sikker p� at du vil slette denne meldingen?';
		$this->pm_sure_delall = 'Er du sikker p� at du vil slette alle meldinger i denne katalog?';
	...
	function post()
	{
		...
		$this->post_attach_disrupt = 'Legge til eller ta bort vedlagte filer vil ikke p�virke ditt innlegg.';
		...
		$this->post_cant_poll = 'Som gjest har du ikke tillatelse til � lage avstemminger. Hvis du registrerer deg kan du ha mulighet til � gj�re dette.';
		$this->post_cant_poll1 = 'Du har ikke tillatelse til � lage avstemminger.';
		...
		$this->post_cant_reply2 = 'Du har ikke tillatelse til � svare p� emne.';
		...
		$this->post_flood = 'Du har lagt inn et innlegg de siste %s sekundene, og kan ikke legge inn et nytt innlegg n�.<br /><br />Pr�v igjen om ytterligere noen sekunder.';
		...
		$this->post_mbcode_limegreen = 'Lime Gr�nn';
		...
		$this->post_mbcode_royalblue = 'Lysebl�';
		$this->post_mbcode_sandybrown = 'Sandbrun';
		$this->post_mbcode_seagreen = 'Sj�gr�nn';
		$this->post_mbcode_sienna = 'Brun';
		$this->post_mbcode_silver = 'S�lv';
		$this->post_mbcode_size = 'St�rrelse';
		$this->post_mbcode_skyblue = 'Himmelbl�';
		...
		$this->post_must_options = 'Du m� inkludere valg n�r du lager en avstemming.';
		$this->post_must_title = 'Du m� skrive en titel n�r du skal lage et nytt emne.';
		...
		$this->post_no_vote = 'Du m� velge en valg n�r du skal stemme.';
		...
		$this->post_too_many_options = 'Du m� ha mellom 2 och %d alternativ i en avstemming.';
	...
	function profile()
	{
		...
		$this->profile_must_user = 'Du m� skrive inn et brukernavn for � se en profil.';
		$this->profile_no_member = 'Det finnes ingen brukere med denne brukerID. Kontoen kan v�re slettet.';
	...
	function recent()
	{
		...
		$this->recent_noview = 'Du har ikke tiletelse � se p� forum.';
		$this->recent_pages = 'Sider';
		$this->recent_pinned = 'Merket';
		$this->recent_pinned_topic = 'Merket emne';
		$this->recent_poll = 'Avstemmning';
		$this->recent_regfirst = 'Du har ikkee tilgang til � se p� forum uten f�rst � registrere deg.';
		...
		$this->recent_subscribe = 'Motta e-post n�r det kommer nye innlegg i dette forum.';
	...
	function register()
	{
		...
		$this->register_activation_error = 'Det uppstod en feil n�r din brukerkonto skulle aktiveres. Kontroller at din nettleser har den komplette aktiveringsadressen fra e-posten. Om problemet vedvarer, kontakt forumets administrator for � f� tilsendt en ny e-post mned aktiveringslink.';
		$this->register_confirm_passwd = 'Bekrefte passordet';
		$this->register_done = 'Du er registrert! Du kan n� logge in.';
		...
		$this->register_pass_invalid = 'Passordet du skrev inn er ugyldig. Forsikre deg om at det bare inneholder gyldige tegn som bokstaver, siffer, strek, understrek og mellomrom. Passordet m� ogs� inneholde minst 5 tegn.';
	...
	function search()
	{
		...
		$this->search_basic = 'Enkel s�king';
		...
		$this->search_in_posts = 'S�k bare i innlegg';
		...
		$this->search_no_results = 'Ditt s�k ga ingen resultat.';
		$this->search_no_words = 'Du m� oppgi noen s�keord.<br /><br />Hvert s�keord m� v�re minst 3 tegn inklusiv bokstaver, siffer, apostrofer og understrek.';
		...
		$this->search_regex = 'S�k med vanlige uttrykk';
		...
		$this->search_sound = 'S�k phonetisk';
	...
	function topic()
	{
		...
		$this->topic_links_web = 'Bes�k %s\'s hjemmeside';
		...
		$this->topic_perm_view_guest = 'Du har ikke tillatelse til � lese emner f�r du har registret deg.';
		$this->topic_pin = 'Merk';
		...
		$this->topic_subscribe = 'Motta e-post n�r det kommer nye innlegg i dette emne.';
