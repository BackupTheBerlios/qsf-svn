...
class he
{
	...
	function perms()
	{
		...
		$this->perms_search_noflood = 'Exempt from search flood control'; //Tranlate
	...
	function pm()
	{
		...
		$this->pm_fields = '.הודעתך לא נשלחה. וודא ששדות החובה מלאים'; //Translate
	...
	function register()
	{
		...
		$this->register_must_activate = '% יחד עם מידע כיצד להפעיל את חשבונך.לתשומת ליבך חשבונך יהיה מוגבל עד שתפעיל אותו.s נרשמת בהצלחה. אימייל נשלח לכתובת'; 
