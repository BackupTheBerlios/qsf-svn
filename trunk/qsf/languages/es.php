...
class es
{
	function active()
	{
		$this->active_last_action = '�ltima acci�n';
		$this->active_modules_active = 'Desplegando usuarios activos';
		$this->active_modules_board = 'Desplegando el �indice';
	...
	function board()
	{
		...
		$this->board_nobday = 'No hay cumplea�os de miembros hoy';
		$this->board_nobody = 'No hay miembros en l�nea';
		$this->board_nopost = 'No hay mensajes';
		$this->board_noview = 'No tiene permiso para ver la lista de mensajes';
		$this->board_regfirst = 'No tiene permiso para ver la lista de mensajes, pero si se registra, podr� tener esa capacidad';
		$this->board_replies = 'Respuestas';
		$this->board_stats = 'Estad�sticas';
		...
		$this->board_write_topics = 'Puede ver y crear t�picos en este foro';
	}
	...
	function cp()
	{
		...
		$this->cp_already_member = 'El correo electr�nico que ha inscrito ya esta asignado a otro miembro';
		$this->cp_apr = 'Abril';
		$this->cp_aug = 'Agosto';
		...
		$this->cp_avatar_upload_too_large = 'El archivo de avatar que especifico es muy grande, el tama�o maximo es de %d kilobytes.';
		$this->cp_avatar_url = 'Especificar un URL para su avatar';
		$this->cp_avatar_use = 'Usar su avatar cargado';
		$this->cp_bday = 'Cumplea�os';
		$this->cp_been_updated = 'Su perf�l ha sido actualizados';
		...
		$this->cp_email = 'Correo electr�nico';
		$this->cp_email_form = 'Permitir a otros contactarlo via formulario de correo electr�nico?';
		$this->cp_email_invaid = 'La cuenta de correo electr�nico que especifico es invalida';
		$this->cp_err_avatar = 'Error al actualizar su avatar';
		$this->cp_err_updating = 'Error al actualizar perf�l';
		$this->cp_feb = 'Febrero';
		...
		$this->cp_label_edit_profile = 'Editar perf�l';
		...
		$this->cp_show_email = 'Mostrar correo electr�nico en perf�l?';
		$this->cp_signature = 'Firma';
		$this->cp_size_max = 'El avatar especifiaco es muy grande. El tama�o maximo permitido es %s por %s pixeles.';
		...
		$this->cp_topic_option = 'Opciones de t�pico';
		$this->cp_updated = 'perf�l actualizado';
		...
		$this->cp_welcome = 'Bienvenido al panel de control de usuario. Aqui podr� configurar su cuenta. Seleccione de las opciones arriba';
	...
	function email()
	{
		...
		$this->email_email = 'Correo electr�nico';
	...
	function forum()
	{
		...
		$this->forum_can_topics = 'Puede ver t�picos en este foro';
		$this->forum_cant_post = 'No puede responder en este foro';
		$this->forum_cant_topics = 'No puede ver t�picos en este foro';
		$this->forum_dot = 'punto';
		$this->forum_dot_detail = 'Muestra que ha publicado o contestado en este t�pico';
		$this->forum_forum = 'Foro';
		$this->forum_guest = 'Invitado';
		$this->forum_hot = 'Activo';
		$this->forum_icon = '�cono de Mensaje';
		$this->forum_jump = 'Brincar al t�pico m�s reciente';
		$this->forum_last = 'Ultima publicaci�n';
		...
		$this->forum_new_topic = 'Crear nuevo t�pico';
		$this->forum_no_topics = 'No hay t�picos para desplegar en este foro';
		...
		$this->forum_pinned_topic = 't�pico Fijado';
		$this->forum_poll = 'Encuesta';
		$this->forum_regfirst = 'No tiene permiso para ver los foros, si se registra, podr� hacerlo';
		$this->forum_replies = 'Respuestas';
		$this->forum_starter = 'Iniciador';
		$this->forum_sub = 'Sub-Foro';
		$this->forum_sub_last_post = 'Ultima publicaci�n';
		$this->forum_sub_replies = 'Respuestas';
		$this->forum_sub_topics = 't�picos';
		$this->forum_subscribe = 'Notificarme via correo electr�nico cuando se publique en este foro';
		$this->forum_topic = 't�pico';
		...
		$this->forum_write_topics = 'Puede crear t�picos en este foro';
	}
	...
	function login()
	{
		$this->login_cant_logged = 'No pudo firmarse, verifique que su nombre de usuario y/o password sea correcto.<br /><br />Ambos son sensibles a mayusculas y minusculas, por lo que \'UsUARIO\' es diferente de \'Usuario\'. Tambien verifique, que las cookies est�n habilitadas en su sistema o navegador.';
	...
	function members()
	{
		...
		$this->members_email = 'Correo electr�nico';
		$this->members_email_member = 'enviar correo electr�nico a este miembro';
	...
	function mod()
	{
		$this->mod_confirm_post_delete = 'Esta seguro de borrar esta publicaci�n?';
		$this->mod_confirm_topic_delete = 'Esta seguro de borrar este t�pico?';
		$this->mod_error_first_post = 'No puede borrar la primera publicaci�n en un t�pico';
		$this->mod_error_move_category = 'No puede mover un t�pico a una categoria';
		$this->mod_error_move_create = 'You do not have permission to move topics to that forum.'; //Translate
		$this->mod_error_move_forum = 'No puede mover un t�pico a un foro que no existe';
		$this->mod_error_move_global = 'You cannot move a global topic. Edit the topic before moving it.'; //Translate
		$this->mod_error_move_same = 'No puede mover un t�pico al foro al que ya existe';
		...
		$this->mod_label_post_delete = 'Borrar publicaci�n';
		$this->mod_label_post_edit = 'Editar publicaci�n';
		...
		$this->mod_label_topic_delete = 'Borrar t�pico';
		$this->mod_label_topic_edit = 'Editar t�pico';
		$this->mod_label_topic_lock = 'Bloquear t�pico';
		$this->mod_label_topic_move = 'Mover t�pico';
		$this->mod_label_topic_move_complete = 'Transferir completamente el t�pico al nuevo foro';
		$this->mod_label_topic_move_link = 'Transferir el t�pico la nuevo foro, y dejar una liga a su nueva ubicacion en el foro anterior';
		$this->mod_label_topic_pin = 'Fijar t�pico';
		$this->mod_label_topic_split = 'Split Topic'; //Translate
		$this->mod_missing_post = 'La publicaci�n especificada no existe';
		$this->mod_missing_topic = 'El t�pico especificado no existe';
		$this->mod_no_action = 'Debe especificar una acci�n';
		$this->mod_no_post = 'Debe especificar una publicaci�n';
		$this->mod_no_topic = 'Debe especificar un t�pico';
		$this->mod_perm_post_delete = 'No tiene permiso para borrar esta publicaci�n';
		$this->mod_perm_post_edit = 'No tiene permiso de editar esta publicaci�n';
		$this->mod_perm_topic_delete = 'No tiene permiso de borrar este t�pico';
		$this->mod_perm_topic_edit = 'No tiene permiso de editar este t�pico';
		$this->mod_perm_topic_lock = 'No tiene permiso de bloquear este t�pico';
		$this->mod_perm_topic_move = 'No tiene permiso de mover este t�pico';
		$this->mod_perm_topic_pin = 'No tiene permiso para fijar este t�pico';
		$this->mod_perm_topic_split = 'You do not have permission to split this topic.'; //Translate
		$this->mod_perm_topic_unlock = 'No tiene permiso para desbloquear este t�pico';
		$this->mod_perm_topic_unpin = 'No tiene permiso de quitar la fijacion a este t�pico';
		$this->mod_success_post_delete = 'La publicaci�n fue borrada satisfactoriamente';
		$this->mod_success_post_edit = 'La publicaci�n fue editada satisfactoriamente';
		$this->mod_success_split = 'The topic was successfully split.'; //Translate
		$this->mod_success_topic_delete = 'El t�pico fue borrado satisfactoriamente';
		$this->mod_success_topic_edit = 'El t�pico fue editado satisfactoriamente';
		$this->mod_success_topic_move = 'El t�pico fue movido satisfactoriamente al nuevo foro';
	}
	...
	function post()
	{
		...
		$this->post_attach_disrupt = 'Agregar o borrar anexos no modificara su publicaci�n';
		...
		$this->post_attach_too_large = 'El archivo es demasiado grande, el tama�o m�ximo es %d KB.';
		$this->post_cant_create = 'Como Invitado, no tiene permiso de crear t�picos. Si lo desea, puede registrarse para hacerlo';
		$this->post_cant_create1 = 'No tiene permiso para crear t�picos';
		$this->post_cant_enter = 'Su voto no pudo ser incluido, porque ya hab�a votado en esta encuesta o no tiene permiso para votar';
		...
		$this->post_cant_reply = 'No tiene permiso para responder a t�picos en este foro';
		$this->post_cant_reply1 = 'Como Invitado, no tiene permiso para responder a t�picos. Si lo desea, puede registrarse para hacerlo';
		$this->post_cant_reply2 = 'You do not have permission to reply to topics.'; //Translate
		$this->post_closed = 'Este t�pico ha sido cerrado';
		$this->post_create_poll = 'Crear encuesta';
		$this->post_create_topic = 'Crear t�pico';
		$this->post_creating = 'Creando t�pico';
		$this->post_creating_poll = 'Creando Encuesta';
		$this->post_flood = 'Ha hecho una publicaci�n en los pasados %s segundos, y no puede hacerlo ahora mismo.<br /><br />Por favor intente m�s tarde.';
		$this->post_guest = 'Invitado';
		$this->post_icon = '�cono de publicaci�n';
		...
		$this->post_mbcode_detail = 'Teclee una descripci�n';
		$this->post_mbcode_email = 'Correo Electr�nico';
		...
		$this->post_mbcode_length = 'Su publicaci�n contiene "+length+" caracteres.';
		...
		$this->post_mbcode_size = 'tama�o';
		$this->post_mbcode_skyblue = 'Azul Cielo';
		$this->post_mbcode_small = 'Peque�o';
		$this->post_mbcode_strike = 'Sobrel�nea';
		...
		$this->post_mbcode_tiny = 'Muy peque�o';
		...
		$this->post_must_title = 'Debe incluir un titulo cuando crea un t�pico';
		$this->post_new_poll = 'Nueva Encuesta';
		$this->post_new_topic = 'Nuevo t�pico';
		$this->post_no_forum = 'El foro no fue encontrado';
		$this->post_no_topic = 'No fue especificado ningun t�pico';
		...
		$this->post_topic_detail = 'Descripci�n del t�pico';
		$this->post_topic_title = 'Titulo del t�pico';
		$this->post_view_topic = 'Ver el t�pico completo';
	...
	function printer()
	{
		...
		$this->printer_not_found = 'El t�pico no fue encontrado, pudo haber sido borrado, movido o pudo nunca haber existido';
		$this->printer_not_found_title = 't�pico no encontrado';
		$this->printer_perm_topics = 'No tiene permiso para ver los t�picos';
		$this->printer_perm_topics_guest = 'No tiene permiso para ver los t�picos, si desea inscribirse, podr� hacerlo';
	...
	function profile()
	{
		...
		$this->profile_bday = 'Cumplea�os';
		$this->profile_contact = 'Contacto';
		$this->profile_email_address = 'Correo electr�nico';
		...
		$this->profile_last_post = 'Ultima publicaci�n';
		...
		$this->profile_must_user = 'Debe de teclear un nombre de usuario para ver su perf�l';
		...
		$this->profile_profile = 'perf�l';
		$this->profile_signature = 'Firma';
		$this->profile_unkown = '[ Desconocido ]';
		$this->profile_view_profile = 'Desplegando perf�l';
	...
	function recent()
	{
		...
		$this->recent_can_topics = 'Puede ver t�picos en este foro';
		$this->recent_cant_post = 'No puede responder en este foro';
		$this->recent_cant_topics = 'No puede ver t�picos en este foro';
		$this->recent_dot = 'punto';
		$this->recent_dot_detail = 'Muestra que ha publicado o contestado en este t�pico';
		$this->recent_forum = 'Foro';
		$this->recent_guest = 'Invitado';
		$this->recent_hot = 'Activo';
		$this->recent_icon = '�cono de Mensaje';
		$this->recent_jump = 'Brincar al t�pico m�s reciente';
		$this->recent_last = 'Ultima publicaci�n';
		...
		$this->recent_new_topic = 'Crear nuevo t�pico';
		$this->recent_no_topics = 'No hay t�picos para desplegar en este foro';
		...
		$this->recent_pinned_topic = 't�pico Fijado';
		$this->recent_poll = 'Encuesta';
		$this->recent_regfirst = 'No tiene permiso para ver los foros, si se registra, podr� hacerlo';
		$this->recent_replies = 'Respuestas';
		$this->recent_starter = 'Iniciador';
		$this->recent_sub = 'Sub-Foro';
		$this->recent_sub_last_post = 'Ultima publicaci�n';
		$this->recent_sub_replies = 'Respuestas';
		$this->recent_sub_topics = 't�picos';
		$this->recent_subscribe = 'Notificarme via correo electr�nico cuando se publique en este foro';
		$this->recent_topic = 't�pico';
		...
		$this->recent_write_topics = 'Puede crear t�picos en este foro';
	}
	...
	function register()
	{
		...
		$this->register_done = 'ya ha sido registrado, ahora se podr� firmar normalmente';
		$this->register_email = 'Correo electr�nico';
		$this->register_email_invalid = 'La cuenta de correo electr�nico es invalida, por favor verifiquela';
		...
		$this->register_email_used = 'La cuenta de correo electr�nico ya esta registrada por otro miembro';
	...
	function search()
	{
		...
		$this->search_characters = 'Caracteres de la publicaci�n';
		$this->search_day = 'dia';
		...
		$this->search_newer = 'M�s reciente';
		$this->search_no_results = 'Su busqueda no produjo resultados';
		$this->search_no_words = 'Debe especificar algunos t�rminos para buscar.<br /><br />Cada uno de los t�rminos de busqueda deberan ser de m�s de 4 caracteres, incluyendo Letras, Numeros, apostrofes y guiones bajos';
		$this->search_offline = 'This member is currently offline'; //Translate
		$this->search_older = 'M�s antiguo';
		...
		$this->search_post_icon = '�cono de publicaci�n';
		...
		$this->search_relevance = 'Relevancia de la publicaci�n: %d%%';
		$this->search_replies = 'publicaci�n';
	...
	function topic()
	{
		...
		$this->topic_create_topic = 'Crear un nuevo t�pico';
		$this->topic_delete = 'Borrar';
		$this->topic_delete_post = 'Borrar esta publicaci�n';
		$this->topic_edit = 'Editar';
		$this->topic_edit_post = 'Editar esta publicaci�n';
		$this->topic_edited = 'La ultima modificacu�n fue %s hecha por %s';
		...
		$this->topic_links_email = 'Enviar correo electr�nico a %s';
		...
		$this->topic_locked = 't�pico bloqueado';
		$this->topic_move = 'Mover';
		$this->topic_no_votes = 'No existen votos para esta encuesta';
		$this->topic_not_found = 't�pico No encontrado';
		$this->topic_not_found_message = 'El t�pico no fue encontrado, pudo haber sido borrado, movido o pudo nunca haber existido';
		$this->topic_offline = 'This member is currently offline'; //Translate
		$this->topic_online = 'This member is currently online'; //Translate
		$this->topic_options = 'Opciones de t�pico';
		$this->topic_pages = 'Paginas';
		$this->topic_perm_view = 'No tiene permiso de ver estos t�picos';
		$this->topic_perm_view_guest = 'No tiene permiso de ver estos t�picos, si se registra, podr� hacerlo';
		$this->topic_pin = 'Fijar';
		$this->topic_posted = 'Posted'; //Translate
		$this->topic_posts = 'Publicaciones';
		$this->topic_print = 'Ver versi�n imprimible';
		$this->topic_quote = 'Responder citando a esta publicaci�n';
		$this->topic_reply = 'Responder al t�pico';
		...
		$this->topic_subscribe = 'Enviarme correo electr�nico cuando otros respondan a este t�pico';
		$this->topic_top = 'Go to the top of the page'; //Translate
		$this->topic_unlock = 'Desbloquear';
		$this->topic_unpin = 'Quitar la fijaci�n';
		$this->topic_unreg = 'No registrado';
		$this->topic_view = 'Ver resultados';
		$this->topic_viewing = 'Desplegando t�pico';
