...
class fi
{
	...
	function board()
	{
		...
		$this->board_regfirst = 'Sinulla ei ole oikeuksia t�ll� keskustelualueella. Rekister�itym�ll� saatat saada oikeudet.';
		$this->board_replies = 'Vastauksia';
		$this->board_stats = 'Tilastot';
		$this->board_stats_string = 'Meill� on %s rekister�itynytt� k�ytt�j��. Uusin k�ytt�j�mme on %s, tervetuloa!<br />T��ll� on yhteens� %s keskustelua ja niihin %s vastausta, yhteens� siis %s viesti�.';
	...
	function cp()
	{
		...
		$this->cp_already_member = 'Antamasi s�hk�postiosoite on jo toisella k�ytt�j�ll�.';
		...
		$this->cp_email = 'S�hk�posti';
		$this->cp_email_form = 'Salli toisten k�ytt�jien l�hett�� s�hk�postia lomakkeella?';
		$this->cp_email_invaid = 'Antamasi s�hk�postiosoite ei ole kelvollinen.';
		...
		$this->cp_must_orig = 'K�ytt�j�tunnuksen tulee olla identtinen alkuper�iseen n�htyn�. Voit vain muuttaa kirjainten kokoa ja lis�t� tai poistaa v�lily�ntej�.';
		$this->cp_new_notmatch = 'Uudet sy�tt�m�si salasanat eiv�t t�sm��.';
		...
		$this->cp_pass_notvaid = 'Salasanasi ei kelpaa. Voit k�ytt�� vain perusmerkkej� kuten kirjaimia, numeroita, viivoja, alaviivaa tai v�lily�ntej�.';
		...
		$this->cp_show_email = 'N�yt� s�hk�postiosoite profiilissa';
		...
		$this->cp_view_emoticon = 'N�yt� hymi�t?';
		...
		$this->cp_zone = 'Aikavy�hyke';
	}

	function email()
	{
		$this->email_blocked = 'K�ytt�j� ei hyv�ksy s�hk�postia t�m�n keskustelualueen lomakkeen kautta.';
		$this->email_email = 'S�hk�posti';
		$this->email_msgtext = 'Viesti:';
		$this->email_no_fields = 'Palaa takaisin ja varmista ett� kaikki kohdat on t�ytetty.';
		$this->email_no_member = 'Annetulla nimell� ei l�ytynyt k�ytt�j��';
		$this->email_no_perm = 'Sinulla ei ole oikeuksia l�hett�� s�hk�postia t�m�n keskustelualueen v�lityksell�.';
		$this->email_sent = 'S�hk�postisi on l�hetetty.';
	...
	function forum()
	{
		...
		$this->forum_regfirst = 'Sinulla ei ole oikeuksia lukea huonetta. Rekister�itym�ll� saatat saada oikeudet.';
		...
		$this->forum_subscribe = 'L�het� s�hk�postia kun t�h�n huoneeseen kirjoitetaan viestej�';
	...
	function login()
	{
		$this->login_cant_logged = 'Sinua ei voitu kirjata sis��n. Tarkista ett� k�ytt�j�tunnus ja salasana ovat oikein.<br /><br />Kirjainten koolla on v�li�, joten \'K�YtT�J�\' on eri asia kuin \'K�ytt�j�\'. Tarkista my�s ett� olet sallinut ev�steiden k�yt�n selaimessasi.';
		...
		$this->login_pass_sent = 'Sinulle on luotu uusi salasana, joka on l�hetetty k�ytt�j�tunnuksessasi ilmoitettuun s�hk�postiosoitteeseen.';
	...
	function main()
	{
		...
		$this->main_banned = 'Sinulta on ev�tty kokonaan t�m�n keskustelualueen k�ytt�.';
		...
		$this->main_max_load = 'Valitettavasti %s on t�ll� hetkell� p��sem�tt�miss� liian monen paikalla olevan k�ytt�j�n vuoksi.';
		...
		$this->main_register = 'rekister�idy';
	...
	function members()
	{
		...
		$this->members_email = 'S�hk�posti';
		$this->members_email_member = 'L�het� s�hk�postia t�lle k�ytt�j�lle';
	...
	function mod()
	{
		...
		$this->mod_label_controls = 'Valvojan ty�kalupakki';
		$this->mod_label_description = 'Kuvaus';
		$this->mod_label_emoticon = 'Muuta hymi�t kuviksi?';
	...
	function pm()
	{
		...
		$this->pm_group = 'Ryhm�';
		$this->pm_guest = 'Sinulla ei ole vieraana oikeutta k�ytt�� viestitint�. Kirjaudu sis��n tai rekister�idy.';
		$this->pm_joined = 'Liittyi';
		$this->pm_messenger = 'Viestitin';
		$this->pm_msgtext = 'Viestin sis�lt�';
		$this->pm_multiple = 'Separate multiple recipients with ;'; //Translate
		$this->pm_no_folder = 'Sinun tulee m��ritt�� kansio.';
		$this->pm_no_member = 'Annetulla ID:ll� ei l�ytynyt k�ytt�j��.';
		$this->pm_no_number = 'Annetulla numerolla ei l�ytynyt viesti�.';
	...
	function post()
	{
		...
		$this->post_cant_create = 'Sinulla ei ole vieraana oikeuksia keskustelun aloittamiseen. Rekister�itym�ll� saatat saada oikeuden aloittaa keskustelu.';
		$this->post_cant_create1 = 'Sinulla ei ole oikeuksia aloittaa keskustelua.';
		$this->post_cant_enter = '��nt�si ei voitu vastaanottaa. Olet joko jo antanut ��nen t�h�n kyselyyn tai sinulla ei ole ��nestysoikeuksia.';
		$this->post_cant_poll = 'Sinulla ei ole vieraana oikeuksia luoda kysely�. Rekister�itym�ll� saatat saada oikeuden luoda kysely.';
		...
		$this->post_cant_reply1 = 'Sinulla ei ole vieraana oikeuksia vastata keskusteluihin. Rekister�itym�ll� saatat saada oikeuden kirjoittaa viestej�.';
		...
		$this->post_mbcode_detail = 'Sy�t� kuvaus';
		$this->post_mbcode_email = 'S�hk�posti';
		...
		$this->post_smiles = 'Hymi�it� (lis�� napsauttamalla)';
		...
		$this->post_voting = '��nestet��n';
	}

	function printer()
	{
		$this->printer_back = 'Takaisin';
		$this->printer_not_found = 'Keskustelua ei l�ytynyt. Se on saatettu poistaa, siirt�� tai sit� ei ole ehk� koskaan ollut olemassa.';
		$this->printer_not_found_title = 'Keskustelua ei l�ytynyt';
		$this->printer_perm_topics = 'Sinulla ei ole oikeuksia lukea keskustelua.';
		$this->printer_perm_topics_guest = 'Sinulla ei ole oikeuksia lukea keskustelua. Rekister�itym�ll� saatat saada oikeudet.';
	...
	function profile()
	{
		...
		$this->profile_email_address = 'S�hk�postiosoite';
		...
		$this->profile_no_member = 'Annetulla ID-numerolla ei l�ytynyt k�ytt�j��. Tunnus on ehk� poistettu.';
	...
	function recent()
	{
		...
		$this->recent_can_post = 'Voit vastata keskusteluihin t�ss� huoneessa.';
		$this->recent_can_topics = 'Voit lukea t�m�n huoneen keskusteluja.';
		$this->recent_cant_post = 'Et voi vastata keskusteluihin t�ss� huoneessa.';
		$this->recent_cant_topics = 'Et voi lukea t�m�n huoneen keskusteluja.';
		$this->recent_dot = 'piste';
		$this->recent_dot_detail = 'kertoo ett� olet ottanut osaa keskusteluun';
		...
		$this->recent_no_topics = 'T�ss� huoneessa ei ole viel� keskustelua.';
		$this->recent_noexist = 'M��ritelty� huonetta ei ole olemassa.';
		$this->recent_nopost = 'Ei viestej�';
		...
		$this->recent_regfirst = 'Sinulla ei ole oikeuksia lukea huonetta. Rekister�itym�ll� saatat saada oikeudet.';
		$this->recent_replies = 'Vastauksia';
		$this->recent_starter = 'Aloittaja';
		$this->recent_sub = 'Sis�huone';
		$this->recent_sub_last_post = 'Edellinen viesti';
		$this->recent_sub_replies = 'Vastausta';
		$this->recent_sub_topics = 'Keskustelua';
		$this->recent_subscribe = 'L�het� s�hk�postia kun t�h�n huoneeseen kirjoitetaan viestej�';
		$this->recent_topic = 'Keskustelu';
		$this->recent_topics_new = 'T�ss� huoneessa on uusia viestej�.';
		$this->recent_topics_old = 'T�ss� huoneessa ei ole uusia viestej�.';
		$this->recent_views = 'N�ytetty';
		$this->recent_write_topics = 'Voit aloittaa keskustelun t�ss� huoneessa.';
	}
	...
	function register()
	{
		...
		$this->register_activation_error = 'Tunnustasi aktivoitaessa tapahtui virhe. Varmista ett� selaimen osoitekentt� sis�lt�� s�hk�postissa olleen URLin kokonaisena. Mik�li ongelma toistuu, ota yhteytt� keskustelualueen yll�pitoon ja he l�hett�v�t s�hk�postin uudelleen.';
		$this->register_confirm_passwd = 'Vahvista salasana';
		$this->register_done = 'Sinut on rekister�ity! Voit nyt kirjautua.';
		$this->register_email = 'S�hk�postiosoite';
		$this->register_email_invalid = 'Antamasi s�hk�postisoite ei ole kelvollinen.';
		...
		$this->register_email_used = 'Antamasi s�hk�postiosoite on jo toisella k�ytt�j�ll�.';
		...
		$this->register_must_activate = 'Sinut on rekister�ity. S�hk�posti on l�hetetty osoitteeseen %s sis�lt�en tiedon siit� kuinka voit aktivoida tunnuksesi. Tunnuksesi on rajoitettu kunnes aktivoit sen.';
		$this->register_name_invalid = 'Antamasi nimi on liian pitk�.';
		$this->register_name_taken = 'K�ytt�j�tunnus on jo k�yt�ss�.';
		$this->register_new_user = 'Haluamasi k�ytt�j�tunnus';
		$this->register_pass_invalid = 'Antamasi salasana ei ole kelvollinen. Varmista ett� se sis�lt�� vain kirjaimia, numeroita, viivoja, alaviivoja tai v�lily�ntej� ja ett� se on ainakin viisi merkki� pitk�.';
		$this->register_pass_match = 'Sy�tt�m�si salasanat eiv�t t�sm��.';
		$this->register_passwd = 'Salasana';
		$this->register_reg = 'Rekister�idy';
		$this->register_reging = 'Rekister�id��n';
	...
	function search()
	{
		...
		$this->search_unreg = 'Rekister�itym�t�n';
	...
	function topic()
	{
		...
		$this->topic_links_email = 'L�het� s�hk�postia k�ytt�j�lle %s';
		...
		$this->topic_not_found = 'Keskustelua ei l�ydy';
		$this->topic_not_found_message = 'Keskustelua ei l�ydy. Se on saatettu poistaa, siirt�� tai sit� ei ehk� koskaan ole ollutkaan.';
		...
		$this->topic_perm_view_guest = 'Sinulla ei ole oikeuksia keskustelun lukemiseen. Rekister�itym�ll� saatat saada oikeudet.';
