...
class de
{
	...
	function mbcode()
	{
		...
		$this->mbcode_large = 'Groß';
		$this->mbcode_length = 'Ihre Nachricht hat +length+ Zeichen.';
		$this->mbcode_limegreen = 'Limettengrün';
