...
class de
{
	...
	function board()
	{
		...
		$this->board_topics_new = 'Es sind neue Beitr�ge vorhanden.';
		$this->board_topics_old = 'Es sind keine neuen Beitr�ge vorhanden.';
	...
	function cp()
	{
		...
		$this->cp_avatar_must_select = 'Du musst einen Avatar ausw�hlen.';
		$this->cp_avatar_none = 'Benutze keinen Avatar';
		$this->cp_avatar_pixels = 'Pixel';
		$this->cp_avatar_select = 'W�hle einen Avatar aus';
		...
		$this->cp_avatar_url = 'W�hle eine URL f�r deinen Avatar';
		...
		$this->cp_been_updated_prefs = 'Deine Pr�ferenzen wurden aktualisiert.';
		...
		$this->cp_mar = 'M�rz';
		$this->cp_may = 'Mai';
		$this->cp_msn = 'MSN Identit�t';
		$this->cp_must_orig = 'Dein Name muss identisch mit dem Original sein. Du kannst nur die Klein/Gro�schreibung sowie den Abstand �ndern.';
		...
		$this->cp_pass_notvaid = 'Dein Passwort ist nicht g�ltig. Gehe sicher, das nur g�ltige Zeichen benutzt werden wie z.B. Buchstaben, Zahlen, Bindestriche, Unterstriche oder Leerzeichen.';
		...
		$this->cp_welcome = 'Willkommen im User-Kontrollzentrum. Hier kannst du deinen Account konfigurieren. Bitte w�hle von den oberen Optionen aus.';
		$this->cp_width = 'L�nge';
	...
	function email()
	{
		...
		$this->email_no_fields = 'Geh zur�ck und gehe sicher, das Felder ausgef�llt sind.';
	...
	function forum()
	{
		...
		$this->forum_topics_new = 'Es gibt neue Beitr�ge in diesem Forum.';
		$this->forum_topics_old = 'Es gibt keine neuen Beitr�ge in diesem Forum.';
	...
	function login()
	{
		$this->login_cant_logged = 'Du konntest dich nicht anmelden. �berpr�fe die Richtigkeit deines Usernamens und des Passworts.<br /><br />Sie sind Zeichensensibel, so \'UsErNaMe\' ist anders als \'Username\'. �berpr�fe weiterhin das Cookies im Browser aktiviert sind.';
		...
		$this->login_pass_sent = 'Dein Passwort wurde zur�ckgesetzt. Das neue Passwort wurde an die angegebene Emailaddresse verschickt.';
	...
	function members()
	{
		...
		$this->members_send_pm = 'Schicke dem User eine pers�nliche Nachricht';
	...
	function mod()
	{
		$this->mod_confirm_post_delete = 'Bist du dir sicher, das du diesen Beitrag l�schen willst?';
		$this->mod_confirm_topic_delete = 'Bist du dir sicher, das du dieses Thema l�schen willst?';
		$this->mod_error_first_post = 'Du kannst den ersten Beitrag eines Themas nicht l�schen.';
		...
		$this->mod_no_action = 'Du musst eine Handlung ausw�hlen.';
		$this->mod_no_post = 'Du musst einen Beitrag ausw�hlen.';
		$this->mod_no_topic = 'Du musst ein Thema ausw�hlen.';
		$this->mod_perm_post_delete = 'Du hast nicht die Erlaubnis diesen Beitrag zu l�schen.';
		$this->mod_perm_post_edit = 'Du hast nicht die Erlaubnis diesen Beitrag zu editieren.';
		$this->mod_perm_topic_delete = 'Du hast nicht die Erlaubnis dieses Thema zu l�schen.';
	...
	function pm()
	{
		...
		$this->pm_cant_del = 'Du hast nicht die Erlaubnis diese Nachricht zu l�schen.';
		...
		$this->pm_fields = 'Nachricht wurde nicht verschickt. Gehe sicher, das alle ben�tigten Felder ausgef�llt wurden.';
		...
		$this->pm_no_folder = 'Du musst einen Ordner ausw�hlen.';
		...
		$this->pm_sure_del = 'Bist du sicher, das du diese Nachricht l�schen willst?';
		$this->pm_sure_delall = 'Bist du dir sicher, das du alle Nachrichten in diesem Ordner l�schen willst?';
		$this->pm_title = 'Titel';
		$this->pm_to = 'An';
	}
	...
	function post()
	{
		...
		$this->post_attach_disrupt = 'Hinzuf�gen oder l�schen wird deine Nachricht nicht st�ren.';
		$this->post_attach_failed = 'Der Upload des Anhangs schlug fehl. Die eingegeben Datei existiert vielleicht nicht.';
		$this->post_attach_not_allowed = 'Du kannst solche Dateitypen nicht anh�ngen.';
		...
		$this->post_cant_enter = 'Dein Auswahl konnte nicht eingegeben werden. Entweder hast du schon ausgew�hlt oder du hast keine Erlaubnis.';
		...
		$this->post_flood = 'Du hast in den letzten %s Sekunden gepostet und darfst im Moment nicht mehr.<br /><br />Versuche es sp�ter nochmal.';
		...
		$this->post_mbcode_large = 'Gro�';
		$this->post_mbcode_length = 'Deine Nachricht hat "+length+" Zeichen.';
		$this->post_mbcode_limegreen = 'Limettengr�n';
		...
		$this->post_must_msg = 'Du musst eine Nachricht einf�gen wenn du einen Beitrag schreibst.';
		$this->post_must_options = 'Du musst Optinen einf�gen wenn du eine Umfrage erstellst.';
		$this->post_must_title = 'Du musst einen Titel einf�gen wenn du ein Thema erstellst.';
		...
		$this->post_no_vote = 'Du musst eine Option zum Abstimmen ausw�hlen.';
		...
		$this->post_too_many_options = 'Du brauchst zwischen 2 und %d Optionen f�r eine Umfrage.';
	...
	function profile()
	{
		...
		$this->profile_msn = 'MSN Identit�t';
		...
		$this->profile_yahoo = 'Yahoo Identit�t';
	}
	...
	function recent()
	{
		...
		$this->recent_topics_new = 'Es gibt neue Beitr�ge in diesem Forum.';
		$this->recent_topics_old = 'Es gibt keine neuen Beitr�ge in diesem Forum.';
	...
	function register()
	{
		...
		$this->register_activation_error = 'Es gab ein Problem w�hrend der Aktivierung deines Accounts. �berpr�fe, ob der Browser die komplette URL der Aktivierungsemail beinhaltet. Wenn das Problem weiterhin besteht kontaktiere den Boardadministrator um die Email erneut zu verschicken.';
		...
		$this->register_image_invalid = 'Um zu �berpr�fen, ob du ein menschlicher User bist, musst du den Text vom Bild eintippen.';
		...
		$this->register_new_user = 'Ben�tigter Username';
		$this->register_pass_invalid = 'Das eingegebene Passwort ist nicht g�ltig. Gehe sicher, das nur g�ltige Zeichen wie z.B. Buchstaben, Nummern, Striche, Unterstriche oder Leerzeichen sowie mindestens 5 Zeichen verwendet wurden.';
	...
	function search()
	{
		...
		$this->search_no_words = 'Du musst Suchbegriffe definieren.<br /><br />Jeder Begriff muss l�nger als 3 Zeichen sein, inklusive Buchstaben, Nummern, Apostrophen und Unterstriche.';
		...
		$this->search_regex_failed = 'Die regul�ren Audr�cke schlufgen fehl. Bitte schau in der MySQL Dokumentation f�r Hilfe bei regul�ren Ausdr�cken.';
	...
	function topic()
	{
		...
		$this->topic_links_pm = 'Sende eine pers�nliche Nachricht an %s';
		...
		$this->topic_split_finish = 'Teilen abschlie�en';
