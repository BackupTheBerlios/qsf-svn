...
class de
{
	function active()
	{
		...
		$this->active_modules_recent = 'Neueste Beitr&auml;ge anschauen';
	...
	function admin()
	{
		$this->admin_add_emoticons = 'Emoticons hinzuf&uuml;gen';
		$this->admin_add_member_titles = 'F&uuml;ge automatische Mitgliedertitel hinzu';
		$this->admin_add_templates = 'HTML Template hinzuf&uuml;gen';
		$this->admin_ban_ips = 'IP Adressen sperren';
		$this->admin_censor = 'W&ouml;rter zensieren';
		$this->admin_cp_denied = 'Kein Zutritt';
		$this->admin_cp_warning = 'Das Administrator Kontrollzentrum ist deaktiviert bis sie ihr <b>Installationsverzeichnis</b> gel&ouml;scht haben, es stellt ein ernstes Sicherheitsrisiko dar.';
		...
		$this->admin_db_query = 'SQL-Abfrage ausf&uuml;hren';
		$this->admin_db_restore = 'Backup wiederherstellen';
		$this->admin_delete_forum = 'Forum l&ouml;schen';
		$this->admin_delete_group = 'Gruppe l&ouml;schen';
		$this->admin_delete_help = 'Hilfe l&ouml;schen';
		$this->admin_delete_member = 'Mitglied l&ouml;schen';
		$this->admin_delete_template = 'HTML-Template l&ouml;schen';
		$this->admin_edit_emoticons = 'Emoticons bearbeiten oder l&ouml;schen';
		...
		$this->admin_edit_member_titles = 'Automatische Mitgliedertitel bearbeiten oder l&ouml;schen';
		$this->admin_edit_settings = 'Forumseinstellungen bearbeiten';
		$this->admin_edit_skin = 'Skin bearbeiten oder l&ouml;schen';
		...
		$this->admin_forum_order = '&Auml;ndere die Forenanordnung';
		...
		$this->admin_recount_forums = 'Themen und Antworten nachz&auml;hlen';
	...
	function backup()
	{
		...
		$this->backup_warning = 'Warnung: Alle bestehenden Daten werden &uuml;berschrieben.';
	}
	...
	function board()
	{
		...
		$this->board_mark = 'Beitr&auml;ge als gelesen markieren';
		$this->board_mark1 = 'Alle Beitr&auml;ge und Foren wurden als gelesen markiert.';
	...
	function cp()
	{
		...
		$this->cp_custom_title2 = 'Dies ist ein Privileg nur f&uuml;r Board-Administratoren';
		...
		$this->cp_sub_change = 'Ver&auml;ndere Abonnements';
		$this->cp_sub_delete = 'L&ouml;schen';
		...
		$this->cp_valided = 'Dein Passwort war g&uuml;ltig und wurde ge&auml;ndert.';
	...
	function emot_control()
	{
		...
		$this->emote_add = 'Emoticons hinzuf&uuml;gen';
		$this->emote_added = 'Emoticon hinzugef&uuml;gt.';
	...
	function forums()
	{
		...
		$this->forum_recount = 'Themen und Antworten nachz&auml;hlen';
		$this->forum_select_cat = 'W&auml;hle eine existierende Kategorie um ein Forum zu erstellen.';
	...
	function groups()
	{
		...
		$this->groups_will_be = 'werden gel&ouml;scht.';
		$this->groups_will_become = 'Benutzer der gel&ouml;schten Gruppe werden';
	}

	function help()
	{
		$this->help_add = 'Hilfe hinzuf&uuml;gen';
		$this->help_article = 'Hilfskontrolle';
		$this->help_available_files = 'Hilfe';
		$this->help_confirm = 'Wirklich l&ouml;schen';
		$this->help_content = 'Inhalt';
		$this->help_delete = 'Hilfe l&ouml;schen';
		$this->help_deleted = 'Hilfe gel&ouml;scht.';
	...
	function logs()
	{
		$this->logs_action = 'Aktivit&auml;t';
		$this->logs_deleted_post = 'Beitrag gel&ouml;scht';
		$this->logs_deleted_topic = 'Thema gel&ouml;scht';
		...
		$this->logs_unlocked_topic = 'Thema ge&ouml;ffnet';
		$this->logs_unpinned_topic = 'Thema entnagelt';
		$this->logs_user = 'Benutzer';
		$this->logs_view = 'Moderator Aktivit&auml;ten anschauen';
	}
	...
	function main()
	{
		...
		$this->main_topics_new = 'Es gibt neue Beitr&auml;ge in diesem Forum.';
		$this->main_topics_old = 'Es gibt keine neuen Beitr&auml;ge in diesem Forum.';
	...
	function mass_mail()
	{
		...
		$this->mail_announce = 'Ank&uuml;ndigung von';
		$this->mail_groups = 'Empf&auml;ngergruppen';
	...
	function mbcode()
	{
		...
		$this->mbcode_bold1 = 'F';
		$this->mbcode_chocolate = 'Schokolade';
		$this->mbcode_code = 'Code';
		$this->mbcode_color = 'Farbe';
		$this->mbcode_coral = 'Coral';
		$this->mbcode_courier = 'Courier';
		$this->mbcode_crimson = 'Crimson';
		$this->mbcode_darkblue = 'Dunkelblau';
		$this->mbcode_darkred = 'Dunkelrot';
		$this->mbcode_deepink = 'Dunkelrosa';
		$this->mbcode_detail = 'Beschreibung eingeben';
		$this->mbcode_email = 'Email';
		$this->mbcode_firered = 'Ziegelsteinrot';
		$this->mbcode_font = 'Schriftart';
		$this->mbcode_green = 'Gr&uuml;n';
		$this->mbcode_huge = 'Riesig';
		...
		$this->mbcode_orangered = 'Orange-Rot';
		$this->mbcode_php = 'PHP';
		$this->mbcode_purple = 'Lila';
		$this->mbcode_quote = 'Zitat';
		$this->mbcode_red = 'Rot';
		$this->mbcode_royalblue = 'K&ouml;nigsblau';
		$this->mbcode_sandybrown = 'Beige';
		$this->mbcode_seagreen = 'Seegr&uuml;n';
		$this->mbcode_sienna = 'Sienna';
		$this->mbcode_silver = 'Silber';
		$this->mbcode_size = 'Gr&ouml;&szlig;e';
		$this->mbcode_skyblue = 'Himmelblau';
		$this->mbcode_small = 'Klein';
		$this->mbcode_spoiler = 'Spoiler';
		$this->mbcode_strike = 'Durchgestrichen';
		$this->mbcode_strike1 = 'S';
		$this->mbcode_tahoma = 'Tahoma';
		$this->mbcode_teal = 'Teal';
		$this->mbcode_times = 'Times';
		$this->mbcode_tiny = 'Winzig';
		$this->mbcode_tomato = 'Tomate';
		$this->mbcode_underline = 'Unterstrichen';
		$this->mbcode_underline1 = 'U';
		$this->mbcode_url = 'URL';
		$this->mbcode_verdana = 'Verdana';
		$this->mbcode_wood = 'Wurzelholz';
		$this->mbcode_yellow = 'Gelb';
	}
	...
	function member_control()
	{
		...
		$this->mc_user_avatar_height = 'Avatar H&ouml;he';
	...
	function mod()
	{
		...
		$this->mod_success_topic_delete = 'Das Thema wurde erfolgreich gel&ouml;scht.';
	...
	function perms()
	{
		...
		$this->perms_post_attach = 'Uploads an Beitr&auml;ge anh&auml;ngen';
		$this->perms_post_attach_download = 'Beitragsanh&auml;nge runterladen';
		$this->perms_post_create = 'Antworten erstellen';
		$this->perms_post_delete = 'Jegliche Beitr&auml;ge l&ouml;schen';
		$this->perms_post_delete_own = 'Nur Beitr&auml;ge des Benutzers l&ouml;schen';
		$this->perms_post_edit = 'Jegliche Beitr&auml;ge bearbeiten';
		$this->perms_post_edit_own = 'Nur Beitr&auml;ge des Benutzers bearbeiten';
		...
		$this->perms_topic_delete = 'Jegliche Themen l&ouml;schen';
		$this->perms_topic_delete_own = 'Nur Themen des Benutzers l&ouml;schen';
		...
		$this->perms_topic_lock = 'Jegliche Themen schlie&szlig;en';
		$this->perms_topic_lock_own = 'Themen des Benutzers schlie&szlig;en';
		...
		$this->perms_topic_unlock = 'Jegliche Themen &ouml;ffnen';
		$this->perms_topic_unlock_mod = 'Schlie&szlig;ung eines Moderators &ouml;ffnen';
		$this->perms_topic_unlock_own = 'Nur Themen des Benutzers &ouml;ffnen';
		...
		$this->perms_user_inherit = 'Der Benutzer wird die Gruppenberechtigungen &uuml;bernehmen.';
	}

	function php_info()
	{
		$this->php_error = 'Fehler';
		$this->php_error_msg = 'phpinfo() kann nicht ausgef&uuml;hrt werden. Es scheint das der Host dieses Feature deaktiviert hat.';
	}
	...
	function pm()
	{
		...
		$this->pm_recipients = 'Empf&auml;nger';
	...
	function prune()
	{
		$this->prune_action = 'Aufr&auml;umaktionen';
		...
		$this->prune_forums = 'W&auml;hle Forum in dem aufger&auml;umt werden soll';
		$this->prune_invalidage = 'Ung&uuml;ltiges Alter zum Aufr&auml;umen spezifiziert';
		$this->prune_move = 'Verschieben';
		$this->prune_moveto_forum = 'Forum verschieben nach';
		$this->prune_nodest = 'Kein g&uuml;ltiges Ziel ausgew&auml;hlt';
		$this->prune_notopics = 'Keine Themen zum Aufr&auml;umen ausgew&auml;hlt';
		$this->prune_notopics_old = 'Keine Themen sind alt genug zum Aufr&auml;umen';
		$this->prune_novalidforum = 'Keine g&uuml;ltigen Foren zum Aufr&auml;umen spezifiziert';
		$this->prune_select_age = 'W&auml;hle Alter der Themen bis zu welchem aufger&auml;umt werden soll';
		$this->prune_select_topics = 'W&auml;hle Themen zum Aufr&auml;umen oder w&auml;hle alle';
		$this->prune_success = 'Themen wurden aufger&auml;umt';
		$this->prune_title = 'Themen-Aufr&auml;umer';
		$this->prune_topics_older_than = 'R&auml;ume Themen auf die &auml;lter sind als';
	}
	...
	function search()
	{
		...
		$this->search_in_posts = 'Suche nur in Beitr&auml;gen';
		$this->search_ip = 'IP';
		...
		$this->search_select_all = 'W&auml;hle alle aus';
		$this->search_show_posts = 'Zeige &uuml;bereinstimmende Beitr&auml;ge';
	...
	function settings()
	{
		...
		$this->settings_avatar_upload = 'Hochgeladene Avatare - Maximale Dateigr&ouml;&szlig;e';
		$this->settings_basic = 'Bearbeite Board-Einstellungen';
		$this->settings_blank = 'Benutze <i>_blank</i> f&uuml;r ein neues Fenster.';
		...
		$this->settings_board_rssfeed_posts = 'Anzahl der Beitr&uuml;ge die via RSS Feed erscheinen sollen';
		...
		$this->settings_db_prefix = 'Tabellenpr&auml;fix';
		...
		$this->settings_email_fake = 'Nur f&uuml;r die Anzeige. Es sollte keine echte Emailadresse sein.';
		$this->settings_email_from = 'E-mail Von-Adresse';
		$this->settings_email_place1 = 'Platziere Mitglieder in die';
		$this->settings_email_place2 = 'Gruppe bis sie ihre Emailadresse best&auml;tigt haben';
		$this->settings_email_place3 = 'Ben&ouml;tigt keine Email-Aktivierung';
		...
		$this->settings_email_valid = 'Neue Mitglieder Email-Best&auml;tigung';
		...
		$this->settings_hot_topic = 'Beitr&auml;ge f&uuml;r ein hei&szlig;es Thema';
		$this->settings_kilobytes = 'Kilobytes';
		$this->settings_max_attach_size = 'Anh&auml;nge - Maximale Dateigr&ouml;&szlig;e';
		...
		$this->settings_posts_topic = 'Beitr&auml;ge pro Themenseite';
	...
	function templates()
	{
		...
		$this->add_in = 'F&uuml;ge Template hinzu:';
		$this->all_fields_required = 'Alle Felder werden ben&ouml;tigt um ein Template hinzuzuf&uuml;gen';
		$this->choose_set = 'W&auml;hle einen Template-Satz';
		$this->choose_skin = 'W&auml;hle ein Skin';
		$this->confirm1 = 'Mit der Best&auml;tigung l&ouml;schen sie das';
		...
		$this->export_select = 'W&auml;hle ein Skin f&uuml;r den Export';
		$this->export_skin = 'Skin exportieren';
		$this->install_done = 'Skin wurde erfolgreich installiert.';
		$this->install_exists1 = 'Es scheint als w&auml;re der Skin';
		$this->install_exists2 = 'schon gel&ouml;scht.';
		$this->install_overwrite = '&Uuml;berschreiben';
		$this->install_skin = 'Skin installieren';
		$this->menu_title = 'W&auml;hle einen Template-Bereich zum Bearbeiten';
		$this->only_skin = 'Es ist nur ein Skin installiert. Sie k&ouml;nnen diesen Skin nicht l&ouml;schen.';
		$this->or_new = 'Oder erstelle neuen Template-Satz mit dem Namen:';
		$this->select_skin = 'W&auml;hle ein Skin aus';
		...
		$this->skin_dup = 'Es wurden ein Skin mit doppeltem Verzeichnisnamen gefunden. Das Skin-Verzeichnung wurde ge&auml;ndert in';
		$this->skin_name = 'Sie m&uuml;ssen einen Namen f&uuml;r den Skin vergeben.';
		...
		$this->template_confirm = 'Sie haben das Template ver&auml;ndert. Wollen sie die &Auml;nderungen speichern?';
		...
		$this->temps_censoring = 'Administrator Kontrollzentrum W&ouml;rterzensierung';
		...
		$this->upgrade_skin_detail = 'Skins die mit dieser Methode modernisiert wurden ben&ouml;tigen eine nachtr&auml;gliche Anpassung des Templates.<br />W&auml;hle Skin aus';
		$this->upgrade_skin_upgraded = 'Skin wurde modernisiert.';
		$this->upgraded_templates = 'Die folgenden Templates wurden hinzugef&uuml;gt';
	}

	function titles()
	{
		$this->titles_add = 'Mitgliedertitel hinzuf&uuml;gen';
		$this->titles_added = 'Mitgliedertitel hinzugef&uuml;gt.';
		$this->titles_control = 'Mitgliedertitel-Kontrolle';
		$this->titles_edit = 'Bearbeite Mitgliedertitel';
		$this->titles_error = 'Kein Titel oder Mindest-Beitr&auml;ge angegeben';
		$this->titles_image = 'Bild';
		$this->titles_minpost = 'Mindest-Beitr&auml;ge';
	...
	function topic()
	{
		...
		$this->topic_delete = 'L&ouml;schen';
		$this->topic_delete_post = 'L&ouml;sche diesen Beitrag';
		...
		$this->topic_no_older = 'Es gibt kein &auml;lteres Thema.';
		$this->topic_no_votes = 'Es gibt keine Abstimmungen f&uuml;r diese Umfrage.';
		$this->topic_not_found = 'Thema nicht gefunden';
		$this->topic_not_found_message = 'Das Thema konnte nicht gefunden werden. Es wurde vielleicht gel&ouml;scht, verschoben oder existierte nie.';
		$this->topic_offline = 'Dieses Mitglied ist momentan offline';
		$this->topic_older = '&Auml;lteres Thema';
		...
		$this->topic_split_finish = 'Teilung abschlie&szlig;en';
