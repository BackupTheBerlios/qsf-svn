...
class de
{
	...
	function mbcode()
	{
		...
		$this->mbcode_large = 'Groÿ';
		$this->mbcode_length = 'Deine Nachricht hat +length+ Zeichen.';
		$this->mbcode_limegreen = 'Limettengrÿn';
		...
		$this->mbcode_red = 'Rot';
		$this->mbcode_royalblue = 'Kÿnigsblau';
		$this->mbcode_sandybrown = 'Sandy Braun';
		$this->mbcode_seagreen = 'Seegrÿn';
		$this->mbcode_sienna = 'Sienna'; //Translate
		$this->mbcode_silver = 'Silber';
		$this->mbcode_size = 'Grÿÿe';
		$this->mbcode_skyblue = 'Himmelsblau';
